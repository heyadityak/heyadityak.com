...
date: 2023-03-18
description: "A step-by-step guide to installing commercial wildcard SSL certificates on NGINX - from generating CSR files to domain validation and certificate bundling."
image: "/images/blog/ssl-certificates-nginx-blog/cover.jpg"
tags: ["SSL", "NGINX", "Security", "Tutorial", "HTTPS"]
---
...
Make a note of the `commonName` section. Since I’m generating a wildcard certificate, I will be providing `*.`[`domain.com`](http://domain.com). If I don’t use this, Comodo will throw an error saying that the Common Name must be a Wildcard one.
