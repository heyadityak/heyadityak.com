...
date: 2023-03-11
description: "How to write effective Linux service files such that you can get rid of hacky ways to run your application in a Linux server."
image: "/images/blog/service-files-blog/cover.jpg"
tags: ["Linux", "Service Files", "Tutorial", "Systemd"]
---

## TLDR;

If you would like to write a basic systemd service file or a Supervisor conf, follow the links [here (systemd)](https://gist.github.com/heyadityak/ab2e46988cccc0a5e6dd289065551d8d) and [here (supervisor)](https://gist.github.com/heyadityak/c71e157ae79822c3c3587ee427498317). These contain a basic template of the service file. You can modify the parts of it as per your requirements. Once done, reload the daemons (both supervisor & systemd) and the services will be running.
